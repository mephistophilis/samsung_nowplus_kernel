...
struct omap_board_mux board_mux[]  = {
        ...
        //"PCMSEL" gpio_52
        OMAP3_MUX(GPMC_NCS1,            OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN), //mephisto change
        ...
        OMAP3_MUX(GPMC_WAIT1,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),  //mephisto change
        //"CAMERA VGA RST" gpio_64
        OMAP3_MUX(GPMC_WAIT2,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),  //mephisto change
        //"FM_nRST" gpio_65
        OMAP3_MUX(GPMC_WAIT3,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),  //mephisto change
        ...
        OMAP3_MUX(CAM_FLD,              OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),  //mephisto change
	    //"LCD REG RST" gpio_99
        ...
        OMAP3_MUX(CAM_D2,               OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN ),  //mephisto change
        ...
        //"PDA ACTIVE" gpio_111
        OMAP3_MUX(CAM_XCLKB,            OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),  //mephisto change
        //"CAMERA LEVEL CTRL" gpio_112
        OMAP3_MUX(CAM_WEN,              OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),  //mephisto change
        //"UART SEL" gpio_113
        OMAP3_MUX(CAM_STROBE,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),  //mephisto change
...
#endif
        //"PHONE ON" gpio_140
        OMAP3_MUX(MCBSP3_DX,            OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN), //mephisto change
        //"MOTOR EN" gpio_141
        OMAP3_MUX(MCBSP3_DR,            OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN), //mephisto change
        //"TOUCH INT" gpio_142
        ...
        //"USB SEL" gpio_150
        OMAP3_MUX(UART1_CTS,            OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN), //mephisto change
        //"RGB RST" gpio_151
        OMAP3_MUX(UART1_RX,             OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN), //mephisto change
        //"CAMERA EN" gpio_152
        OMAP3_MUX(MCBSP4_CLKX,          OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN), //mephisto change
        ...
        OMAP3_MUX(MCBSP4_FSX,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP), //mephisto change
        //"HW REV0" gpio_156
        OMAP3_MUX(MCBSP1_CLKR,          OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT),
        //"TA Enable" gpio_157
        OMAP3_MUX(MCBSP1_FSR,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP ), //mephisto change
        //"HW REV1" gpio_158
		...
		//"WLAN EN" gpio_160
		OMAP3_MUX(MCBSP_CLKS,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP),  //mephisto change
		//"LCD ID" gpio_161
        OMAP3_MUX(MCBSP1_FSX,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN ),  //mephisto change
        //"EAR MIC PWR EN" gpio_162
        OMAP3_MUX(MCBSP1_CLKX,          OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN),  //mephisto change
        ...
        //"UART1 RXD"
        OMAP3_MUX(UART3_RX_IRRX,        OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT ),  //mephisto change
        //"UART1 TXD"
        OMAP3_MUX(UART3_TX_IRTX,        OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT),  //mephisto change
...
// -> fix touch fail after boot
        //"TOUCH I2C SCL"
        OMAP3_MUX(I2C3_SCL,             OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLUP), //mephisto change
        //"TOUCH I2C SDA"
        OMAP3_MUX(I2C3_SDA,             OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLUP), //mephisto change
#endif
        //"MLCD RST" gpio_170
        OMAP3_MUX(HDQ_SIO,              OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP ),  //mephisto change
        //"DISPLAY CLK"
        ...
        //"TVOUT SEL" gpio_177
        OMAP3_MUX(MCSPI1_CS3,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN), //mephisto change
        //"PHONE RESET" gpio_178
        OMAP3_MUX(MCSPI2_CLK,           OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP), //mephisto change
        //"VIB FREQ"
        ...
        OMAP3_MUX(CHASSIS_NIRQ,                 OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT ),  //mephisto change
        OMAP3_MUX(CHASSIS_FIQ,                  OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT ),  //mephisto change
        ...
        OMAP3_MUX(CHASSIS_MSTDBY,               OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP ),   //mephisto change
        OMAP3_MUX(CHASSIS_IDLEREQ,              OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT),
        OMAP3_MUX(CHASSIS_IDLEACK,              OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_INPUT_PULLUP),   //mephisto change
        ...
        //"TWL4030 MSECURE"
        OMAP3_MUX(ETK_D8,                       OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP), //mephisto change
        //"MMC1 DETECT"
